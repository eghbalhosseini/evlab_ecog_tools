function [trial_timing_dec] = get_timing_from_json_files_LangLocVisual_v2(ecog_obj,all_trial_timing,events_table,audio_align_path,with_wavelet,do_downsample)
