    ...
    methods
            ...
            if ops.do_plot
                ...
                for i=1:size(S_dat,1)
                    ...
                    if ~mod(i,num_rows) | i==size(S_dat,1)
                        ...
                        set(gcf,'PaperPosition',[.25 .25 8 6])
                        set(gcf,'PaperOrientation','landscape');
                        fname=sprintf('%s_s_v_n_words-%d-%d_p_%0.2f_%s_%s_%s_tiny_unipolar_1.pdf',obj.subject_id,...
                            min(ops.words),...
                            max(ops.words),...
                            ops.threshold,...
                            ops.side,...
        ...
        function plot_per_shank(obj,varargin)
            ...
            if strcmp(ops.elec_config, 'SEEG')
                ...
                set(gcf,'PaperOrientation','landscape');
                                fname=sprintf('%s_%s_%s_%s_tiny_per_shank.pdf',obj.subject_id,obj.modality,ops.signal_type,ops.elec_config);
