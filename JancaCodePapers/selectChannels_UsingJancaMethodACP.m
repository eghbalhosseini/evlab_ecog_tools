...
function [tableChanSelection] = selectChannels_UsingJancaMethodACP...
...
% Combine segments to assess overal IEDs across all available segments
...
% Sanity check
 if numChanIni ~= size(currIEDs.discharges.MV, 2); error('Why number of channels differ! I am kind of a silly and confusing warning message!'); end
