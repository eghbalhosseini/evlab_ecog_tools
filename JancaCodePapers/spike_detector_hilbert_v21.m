function [out, discharges, d_decim, envelope, background, envelope_pdf]=spike_detector_hilbert_v21(d,fs,settings)
...
%   -bh high frequency of filtering ('-bh 60' DEFAULT)
...
%             
    ...
    discharges.MRAW=[discharges.MRAW;mraw];
